...
#  tar file (c07Files.tar) posted on the course website; that tar file must
#  contain:
#
...
#
#  Invocation:  ./gradeC07.sh <name of your tar file>
#               e.g., ./gradeC07.sh wmcquain.C07.1.tar
#
